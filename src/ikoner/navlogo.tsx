function NavLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width={70} height={45} viewBox="0 0 70 45" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="#fff"
      />
      <mask id="prefix__a" maskUnits="userSpaceOnUse" x={64} y={20} width={6} height={12}>
        <path d="M69.845 31.71V20.591h-5.684v11.12h5.684z" fill="#fff" />
      </mask>
      <g mask="url(#prefix__a)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M64.161 31.71l4.435-11.119h1.25l-4.436 11.12h-1.249z"
          fill="#fff"
        />
      </g>
      <path
